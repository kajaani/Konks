...
bool LevelMenuScene::init()
{
	...
	//Level 1 button
		...
		label1->setPosition(Vec2(playButton1->getPosition().x + 210 / 2, playButton1->getPosition().y - 190));
	...
	//Level 2 button
		...
		label2->setPosition(Vec2(playButton2->getPosition().x + 105, playButton2->getPosition().y - 190));
	...
	//Level 3 button
		...
		label3->setPosition(Vec2(playButton3->getPosition().x + 105, playButton3->getPosition().y - 190));
	...
	//Level 5 button
		...
		playButton5->setPosition(Vec2(playButton1->getPosition().x, playButton1->getContentSize().height));
